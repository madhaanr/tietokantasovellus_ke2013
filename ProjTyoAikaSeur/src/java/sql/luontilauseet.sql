...
CONSTRAINT fk_kayttajatunnus FOREIGN KEY (KAYTTAJATUNNUS) REFERENCES KAYTTAJA (KAYTTAJATUNNUS) ON DELETE CASCADE,
CONSTRAINT fk_projekti FOREIGN KEY (PROJEKTIN_NIMI) REFERENCES PROJEKTI (PROJEKTIN_NIMI) ON DELETE CASCADE
);
...
CONSTRAINT fk_kayttajatunnus FOREIGN KEY (KAYTTAJATUNNUS) REFERENCES KAYTTAJA (KAYTTAJATUNNUS) ON DELETE RESTRICT,
CONSTRAINT fk_tyotehtava FOREIGN KEY (TYOTEHTAVAN_NIMI,PROJEKTIN_NIMI) REFERENCES TYOTEHTAVA (TYOTEHTAVAN_NIMI,PROJEKTIN_NIMI) ON DELETE RESTRICT
);